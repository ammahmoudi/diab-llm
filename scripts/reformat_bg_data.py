...
if __name__ == '__main__':
    # parse config file
    csv_path='/home/amma/LLM-TIME/data/raw/540-ws-training.csv'
    save_path='/home/amma/LLM-TIME/data/formated/540-ws-training.csv'
    input_window_size=6
    ...
    csv_path='/home/amma/LLM-TIME/data/raw/540-ws-testing.csv'
    save_path='/home/amma/LLM-TIME/data/formated/540-ws-testing.csv'
    input_window_size=6
    prediction_window_size=6
    input_features=["BG_{t-5}", "BG_{t-4}", "BG_{t-3}", "BG_{t-2}", "BG_{t-1}", "BG_{t}"]
    labels=["BG_{t+1}", "BG_{t+2}", "BG_{t+3}", "BG_{t+4}", "BG_{t+5}", "BG_{t+6}"]
