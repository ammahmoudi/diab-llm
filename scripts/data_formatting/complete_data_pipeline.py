...
class DataProcessingPipeline:
    ...
    def __init__(self, dry_run=False):
        ...
        self.standardizer_script = self.data_processing_dir / "unified_data_standardizer.py"
        self.formatter_script = self.data_processing_dir / "unified_data_formatter.py"
        self.arrow_converter_script = self.data_processing_dir / "unified_arrow_converter.py"
