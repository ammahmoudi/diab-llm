...
base_output_dir = "./d1namo_experiment_configs_time_llm_training/"
log_level = "INFO"

# Model priority order
model_order = ["BERT",'GPT2']
...
for model in model_order:
    for config_path in config_files_by_model[model]:
        ...
        extract_metrics_to_csv(base_dir=base_output_dir, output_csv='./d1namo_experiment_results_time_llm_training.csv')
