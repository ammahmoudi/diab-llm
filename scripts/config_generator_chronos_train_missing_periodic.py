...
for seed, feature_label_set, model, torch_dtype, mode in product(
    ...
    for patient_id in patients:
        ...
        data_folder = f"/home/amma/LLM-TIME/data/missing_data_periodic/{patient_id}-ws-training.arrow"
        test_data_folder = f"./data/missing_data_periodic/{patient_id}-ws-testing.csv"
