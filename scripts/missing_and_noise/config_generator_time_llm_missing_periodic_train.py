...
base_output_dir_inference = "./experiment_configs_time_llm_inference_missing_periodic_train"
base_output_dir_training = "./experiment_configs_time_llm_training_missing_periodic_train"
...
for (
    ...
    for patient_id in patients:
        ...
        train_folder="./data/missing_data_periodic"
