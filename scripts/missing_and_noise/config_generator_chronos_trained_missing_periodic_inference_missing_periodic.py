...
for seed, feature_label_set, model, torch_dtype, mode in product(
    ...
    for patient_id in patients:
        ...
        if "base" in model:
            training_folder_pattern = "./experiment_configs_chronos_training_missing_periodic/seed_*_model_amazon_chronos-t5-base_dtype_*"
        else:
            training_folder_pattern = "./experiment_configs_chronos_training_missing_periodic/seed_*_model_amazon_chronos-t5-tiny_dtype_*"
        ...
        data_folder = f"./data/missing_data_periodic_formatted/{context_len}_{pred_len}"
