...
base_output_dir_inference = "./experiment_configs_time_llm_inference_noised"
base_output_dir_training = "./experiment_configs_time_llm_training_noised"
...
for (
    ...
    for patient_id in patients:
        ...
        data_folder = "./data/noised_standardized"
