...
base_output_dir_inference = "./experiment_configs_time_llm_inference_missing_random_train"
base_output_dir_training = "./experiment_configs_time_llm_training_missing_random_train"
...
for (
    ...
    for patient_id in patients:
        ...
        data_folder = "./data/missing_data_random"
        train_folder="./data/missing_data_random"
