...
model_order = ["BERT", "DistilBERT", "TinyBERT", "BERT-tiny", "MiniLM", "MobileBERT", "ALBERT", "GPT2", "OPT-125M", "LLAMA"]
...
for model in model_order:
    for config_path in config_files_by_model[model]:
        ...
        extract_metrics_to_csv(base_dir=base_output_dir, output_csv='./experiment_results_time_llm_inference.csv')
