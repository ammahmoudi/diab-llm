...
class Model(nn.Module):
    def __init__(self, configs, patch_len=16, stride=8):
        ...
        self.llm_config = DistilBertConfig.from_pretrained("distilbert-base-uncased")
        self.llm_config.output_hidden_states = True
        self.llm_model = DistilBertModel.from_pretrained("distilbert-base-uncased", config=self.llm_config)
        ...
        self.description = configs["content"] if configs["prompt_domain"] else "Forecasting task with multivariate data."
        ...
        self.output_projection = FlattenHead(
            configs["enc_in"], self.head_nf, self.prediction_length, head_dropout=configs["dropout"]
        )
