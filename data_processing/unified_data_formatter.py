...
Usage:
    python unified_data_formatter.py --dataset ohiot1dm --scenario raw --windows 6,6
    python unified_data_formatter.py --dataset d1namo --scenario all --windows all
    python unified_data_formatter.py --dataset all --scenario all --windows all
"""
