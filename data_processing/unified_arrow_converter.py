...
Usage:
    python unified_arrow_converter.py --dataset all --scenario all
    python unified_arrow_converter.py --dataset d1namo --scenario missing_periodic
    python unified_arrow_converter.py --dataset ohiot1dm --scenario raw
"""
